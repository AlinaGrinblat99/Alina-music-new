      ...
      <section className="relative w-full bg-[#000000]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 py-16 px-6">
          ...
          >
            ...
            <button className="px-8 py-4 rounded-full bg-[#1d1d1f] border border-transparent hover:bg-[#f5f5f7] hover:text-black text-[#f5f5f7] transition-all duration-300 font-semibold text-lg tracking-tight">Включай состояние</button>
          </motion.div>
        </div>
      </section>
